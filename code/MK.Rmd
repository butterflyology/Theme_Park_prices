...
predict(lm_Iger, newdata = new_Iger)
# Predicts next price will be ~129. 
```

Len Testa and others have noted that the current pricing scheme does not contain information for December, 2019; this corresponds with the approximate opening date for Star Wars Galaxy's Edge. If we predict out to 1 December, 2019 the model predicts \$129. I think this will be low because themed entertainment hasn't seen anything like Galaxy's Edge. But, it is a prediction based on historic data and is testable.
